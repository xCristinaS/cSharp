...
namespace CS_Ejercicio04_Coleccion {
    class BddConection {
        ...
        public static SqlConnection newConnection() {
            ...
            SqlConnection connection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=" + Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + @"\BddCollection\Coleccion.mdf" + ";Integrated Security=True;Connect Timeout=30");
            connection.Open();
            return connection;
        }
