...
namespace CS_Ejercicio03_FichaDePersonajes {
    public partial class Form1 : Form {
        ...
        IntPtr cursor = LoadCursorFromFile(System.IO.Path.GetFullPath(@"cursor.cur"));
        ...
        private void cargarImgPersonaje(string personaje) {
            this.BackgroundImage = Image.FromFile(personaje + Constantes.EXTENSION_PNG);
        }
        ...
        private void mute_Click(object sender, EventArgs e) {
            if (reproductor.settings.mute) {
                ...
                mute.BackgroundImage = Image.FromFile("music.png");
            } else {
                reproductor.settings.mute = true;
                mute.BackgroundImage = Image.FromFile("musicOff.png");
            }
        }
